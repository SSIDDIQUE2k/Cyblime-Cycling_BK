  ...
  return (
    <motion.div
      ...
      className={`relative bg-white rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 ${
        isPopular ? 'border-2 border-[#c4e92e] scale-105' : 'border border-gray-100'
      }`}
    >
      {isPopular && (
        <div className="absolute -top-4 left-1/2 -translate-x-1/2">
          <Badge className="bg-[#c4e92e] text-[#1a1a1a] border-0 px-4 py-1">
            Most Popular
          </Badge>
        </div>
      )}
      ...
      <div className="text-center mb-8">
        <div className="w-16 h-16 rounded-2xl bg-[#c4e92e]/10 flex items-center justify-center mx-auto mb-4">
          {plan.icon}
        </div>
      ...
      <div className="text-center mb-8">
        ...
        {plan.savings && (
          <div className="text-sm text-green-600 font-medium">Save ${plan.savings}/year</div>
        )}
      </div>
      ...
      <Button 
        className={`w-full rounded-xl py-6 mb-8 ${
          isPopular 
            ? 'bg-[#c4e92e] hover:bg-[#d4f93e] text-[#1a1a1a]' 
      ...
      <div className="space-y-4">
        ...
        {plan.features.map((feature, i) => (
          <div key={i} className="flex items-start gap-3">
            {feature.included ? (
              <Check className="w-5 h-5 text-[#c4e92e] flex-shrink-0 mt-0.5" />
            ) : (
...
const FeatureCard = ({ icon: Icon, title, description, index }) => {
  return (
    ...
    >
      <div className="w-12 h-12 rounded-xl bg-[#c4e92e] flex items-center justify-center flex-shrink-0">
    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <section className="relative bg-gradient-to-br from-[#1a1a1a] to-[#2a2a2a] py-24 md:py-32 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] rounded-full bg-[#c4e92e]/10 blur-3xl" />
          <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] rounded-full bg-[#c4e92e]/5 blur-3xl" />
        </div>
          ...
          >
            ...
            <div className="flex items-center justify-center gap-8 flex-wrap">
              <div className="text-center">
                <div className="text-4xl font-bold text-[#c4e92e] mb-1">2,500+</div>
                <div className="text-sm text-gray-400 uppercase tracking-wider">Active Members</div>
              </div>
              <div className="hidden md:block w-px h-12 bg-white/10" />
              <div className="text-center">
                <div className="text-4xl font-bold text-[#c4e92e] mb-1">4.9/5</div>
                <div className="text-sm text-gray-400 uppercase tracking-wider">Member Rating</div>
              </div>
              <div className="hidden md:block w-px h-12 bg-white/10" />
              <div className="text-center">
                <div className="text-4xl font-bold text-[#c4e92e] mb-1">50K+</div>
      ...
      <section className="py-24 bg-[#fafafa]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            <span className="inline-block text-xs font-semibold tracking-widest text-[#c4e92e] uppercase mb-4">Membership Plans</span>
      ...
      <section className="py-24 bg-[#fafafa]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          >
            <span className="inline-block text-xs font-semibold tracking-widest text-[#c4e92e] uppercase mb-4">FAQ</span>
            <h2 className="text-4xl md:text-5xl font-bold text-[#1a1a1a] mb-6">
              Common Questions
            </h2>
          </motion.div>
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-br from-[#c4e92e] to-[#d4f93e]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            <Button className="bg-[#1a1a1a] hover:bg-[#2a2a2a] text-white rounded-full px-8 py-6 text-base font-semibold shadow-lg">
              Start Free Trial
              <ChevronRight className="w-5 h-5 ml-2" />
            </Button>
