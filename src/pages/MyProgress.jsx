    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          {/* How to Earn Points */}
          <div className="mt-12 bg-gradient-to-br from-[#FC4C02] to-[#FF7A00] rounded-3xl p-8 text-white">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-white/80">+50 points</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-white/80">+100 points</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-white/80">+25 points</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-white/80">+200 points</div>
                </div>
              </div>
            </div>
          </div>
