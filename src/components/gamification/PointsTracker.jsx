...
export default function PointsTracker({ userEmail }) {
  ...
  return (
    <Card className="bg-gradient-to-br from-[#c9a227]/10 to-transparent border-[#c9a227]/20">
      <CardHeader>
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-3xl font-bold text-[#c9a227]">{userPoints.total_points} pts</p>
          </div>
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#c9a227] to-[#b89123] flex items-center justify-center">
          ...
          <div>
            ...
            <div className="flex gap-2 flex-wrap">
              {achievements.slice(0, 3).map((achievement) => (
                <Badge key={achievement.id} className="bg-[#c9a227] text-white">
