  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-[var(--cy-text)]">
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <p className="text-sm text-[var(--cy-text-muted)]">Let AI design the perfect cycling route for you</p>
        </DialogHeader>
        ...
        {!generatedRoutes ? (
          <div className="space-y-4">
            ...
            <Button 
              ...
              disabled={loading}
              className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-[var(--cy-text)] h-12 text-lg"
            >
              {loading ? (
                <>
                  ...
                  <CardHeader>
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <p className="text-sm text-[var(--cy-text-muted)] mt-1">{route.description}</p>
                      </div>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div className="p-3 bg-gray-50 rounded-lg">
                        <div className="text-xs text-[var(--cy-text-muted)]">Distance</div>
                        <div className="text-lg font-bold text-gray-900">{preferences.distance}km</div>
                      </div>
                      <div className="p-3 bg-gray-50 rounded-lg">
                        <div className="text-xs text-[var(--cy-text-muted)]">Elevation</div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-[var(--cy-text-muted)]">{route.start_location}</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm">
                        <MapPin className="w-4 h-4 text-red-600" />
                        <span className="font-semibold">End:</span>
                        <span className="text-[var(--cy-text-muted)]">{route.end_location}</span>
                      </div>
                    </div>
                    ...
                    <div className="p-3 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
                      ...
                      <p className="text-sm text-[var(--cy-text-secondary)]">{route.elevation_profile}</p>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="space-y-1">
                        {route.highlights.map((highlight, i) => (
                          <li key={i} className="text-sm text-[var(--cy-text-muted)] flex items-start gap-2">
