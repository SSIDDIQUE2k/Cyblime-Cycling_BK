...
const FeedPost = ({ post, index }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-[#141414] rounded-xl p-5 shadow-none hover:shadow-md transition-all"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between mb-10">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-white mb-2">Community Feed</h2>
            <p className="text-gray-400">Latest discussions from our cycling community</p>
          </motion.div>
