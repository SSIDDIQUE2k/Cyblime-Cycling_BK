  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-[#2A2A2A]">{event.title}</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
              ...
              <div>
                <div className="text-xs text-[#555555]">Date</div>
                <div className="font-semibold text-[#2A2A2A]">{event.date}</div>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
              <Clock className="w-5 h-5 text-[#6BCBFF]" />
              <div>
                <div className="text-xs text-[#555555]">Time</div>
                <div className="font-semibold text-[#2A2A2A]">{event.time}</div>
              </div>
            </div>
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl col-span-2">
              <MapPin className="w-5 h-5 text-[#6BCBFF]" />
              <div>
                <div className="text-xs text-[#555555]">Location</div>
                <div className="font-semibold text-[#2A2A2A]">{event.location}</div>
              </div>
            </div>
          </div>
          ...
          {/* Description */}
          <div>
            <h3 className="font-semibold text-[#2A2A2A] mb-2">About</h3>
          ...
          <div>
            ...
            {goingCount > 9 && (
              <p className="text-sm text-[#555555] mt-2">+ {goingCount - 9} more</p>
            )}
          </div>
